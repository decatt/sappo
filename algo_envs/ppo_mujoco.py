...
class PPOMujocoAgent(AlgoBase.AlgoBaseAgent):
    def __init__(self,sample_net:PPOMujocoNet,model_dict,is_checker):
...
class PPOMujocoCalculate(AlgoBase.AlgoBaseCalculate):
    def __init__(self,share_model:PPOMujocoNet,model_dict,calculate_index):
...
if __name__ == "__main__":
    ...
    sample_agent = PPOMujocoAgent(train_net,model_dict,is_checker=False)
    check_agent = PPOMujocoAgent(train_net,model_dict,is_checker=True)
